...
image: https://bitroot.org/blog/media/2026-05-21-elevenlabs-adds-an-albert-einstein-voice-agent.jpg
...
- text-to-speech
- elevenlabs
title: ElevenLabs adds an Albert Einstein voice agent
video: https://video.twimg.com/amplify_video/2056723617455501312/vid/avc1/3840x2160/fnVQc2cYqUs-qPbZ.mp4?tag=27
---

ElevenLabs announced today that its text‑to‑speech platform now includes a synthetic voice modeled after Albert Einstein, bundled with an "Einstein agent" that can narrate his archived writings in that iconic tone. The rollout was shared in a tweet that highlighted the new dimension for learning experiences [source](https://x.com/i/status/2056724239797944618).
