...
image: https://bitroot.org/blog/media/2026-06-18-companies-might-control-the-algorithm.jpg
...
- marketing
- instagram
title: Companies Might Control the Algorithm. But Soon You'll Choose the Algorithm.
---

For most of social media's history, users had very little say in how content reached them.

[Platforms built recommendation systems](https://www.instagram.com/), optimized engagement metrics, and continuously adjusted ranking signals behind the scenes. Users could influence the algorithm through likes, follows, comments, and watch time, but they couldn't directly control it.
...
For years, [recommendation systems](https://www.threads.com/) operated largely behind the scenes.
...
Some [decentralized](https://bsky.app/) and open social networks are exploring customizable feeds and community-driven recommendation systems.
...
[Recent social media updates](https://techcrunch.com/2026/06/17/social-medias-next-evolution-user-controlled-algorithms/) focused on giving users more influence over recommendations are often viewed as standalone product features.
...
- [Stronger communities.](https://www.reddit.com/)
