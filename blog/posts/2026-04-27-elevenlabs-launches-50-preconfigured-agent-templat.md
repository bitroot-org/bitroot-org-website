...
- productivity
- elevenlabs
title: ElevenLabs launches 50+ pre‑configured Agent Templates
---

ElevenLabs announced a library of **Agent Templates** that ships with over 50 pre‑configured ElevenAgents, each bundled with prompts, workflows, and integrations for common business functions such as support, sales, and operations [source](https://x.com/i/status/2048794727881789930).
