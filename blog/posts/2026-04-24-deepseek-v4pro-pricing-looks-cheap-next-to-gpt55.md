...
image: https://bitroot.org/blog/media/2026-04-24-deepseek-v4pro-pricing-looks-cheap-next-to-gpt55.jpg
...
- pricing
- cloud
title: DeepSeek V4‑Pro pricing looks cheap next to GPT‑5.5
---

According to a [tweet](https://x.com/i/status/2047605548346941643) by Kajetan Mastela, OpenAI’s upcoming GPT‑5.5 will cost $5 per million input tokens and $30 per million output tokens—exactly double the $2.50/$15 rates of GPT‑5.4. By contrast, DeepSeek V4‑Pro is listed at $1.74/M input and $3.48/M output, making it appear dramatically cheaper.
