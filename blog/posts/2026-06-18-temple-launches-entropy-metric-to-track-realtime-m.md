...
image: https://bitroot.org/blog/media/2026-06-18-temple-launches-entropy-metric-to-track-realtime-m.jpg
...
- health metrics
- startup tools
title: Temple launches Entropy metric to track real‑time metabolic cost
---
...
Temple is currently accepting applications for early access via its website [http://temple.com](http://temple.com). No pricing tier is disclosed; the tweet implies a “look‑and‑feel” phase before a commercial launch. Startups should assume the eventual product may be subscription‑based, especially if it relies on proprietary hardware or data pipelines.
